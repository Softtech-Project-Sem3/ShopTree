    ...
    public class CustomersController : Controller
    {
        ...
        public ActionResult Register(FormCollection collection)
        {
            ...
            if (customerDB == null)
            {
                ...
                if (collection["Password"].ToString().Equals(collection["ReEnterPassword"].ToString()))
                {
                    ...
                    Session["CustomerName"] = customer.Name;
                    Session["CustomerId"] = customer.Id;
                    SendEmailToCustomer.SendEmailForRegister(customer.Email, customer.Name, customer.Password);
                    return RedirectToAction("Index", "Home");
                }
                else
                {
        ...
        public ActionResult ForgotPassword(string requiredEmail)
        {
            ...
            else
            {
                ...
                db.SaveChanges();
                SendEmailToCustomer.SendEmailForgotPassword(customer.Email, customer.Name, newPassword);
