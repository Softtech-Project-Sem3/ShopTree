    ...
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult CheckOrderWithoutLogin(string orderCode)
        {
            ...
            if (orderDB != null)
            {
                ...
                {
                    //have shipper
                    orderInfomation.ShipperName = orderDB.Shipper.Name;
                    orderInfomation.ShipperEmail = orderDB.Shipper.Email;
                    orderInfomation.ShipperPhone = orderDB.Shipper.Phone;
                    orderInfomation.ShipperAddress = orderDB.Shipper.Address;
                    return View(orderInfomation);
                }
            }
            else
